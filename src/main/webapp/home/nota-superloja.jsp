...
<html ng-app="app">
    ...
    <body ng-controller="HttpCtrl as app">
        ...
        <img style="float: top; width: 100%; padding-bottom: 0.1%; opacity: 0.8; filter: alpha(opacity=80); /* For IE8 and earlier */" src="local_components/img/oldbg.jpg" alt="Notas Fiscais"/>
        <main>
            <!--Main layout-->
        ...
        <script type="text/javascript" src="local_components/js/app3.js"></script>
